...
Nを出してくる試合について
・負ける場合
    1を出して負けることで他のすべての試合で勝つことができる
・引き分ける場合
    Nを出して引き分ける、残りの1~N-1枚のカードによる対決になる
    全部勝てた場合(そんなことは起こらないが)、sum-Nが出てくる試合で得られるポイント数となる
    この値を持っておくことによって、1~N-1枚のカードによる対決もシミュレーションできる
*/
